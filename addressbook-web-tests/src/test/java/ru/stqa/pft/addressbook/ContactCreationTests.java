...
public class ContactCreationTests {
    ...
    public void ContactCreationTests() {
        ...
        wd.findElement(By.name("address")).sendKeys("USA CALIFORNIA");
        ...
        wd.findElement(By.name("email")).sendKeys("google@google.com");
        ...
        wd.findElement(By.name("address2")).sendKeys("6015 USA NEW YORK");
